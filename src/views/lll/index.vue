...
onMounted(() => {
  const myChart = echarts.init(document.querySelector('#china') as HTMLElement);

  axios.get('/api/examples/data/asset/data/lines-bus.json').then((res) => {
...
// const AK = '6XGkFPaIKtOxok7apl7nXqnMSb1Hnudd';
...
//         res.push({
//           // @ts-ignore
//           name: data[i].name as never,
//           value: geoCoord.concat(data[i].value as never),
//         });
//       }
//     }
//     return res;
